...
public interface IAlmacen<E> {
     ...
     */
    public void insertar(IProducto<E> nodo);
     ...
     */
    public IProducto buscar(Comparable clave);
    ...
    /**
     * Inserta un nodo en la variable primero y hace que el nodo que
     * antes estaba referenciado en esta variable sea el siguiente al insertado.
     */
